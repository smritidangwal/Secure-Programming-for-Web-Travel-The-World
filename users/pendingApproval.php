...
<head>
    <title> Travel The World | Pending Posts</title>
    <?php head(); ?>
</head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            try {
                                ...
                                $stmt = $db->query('SELECT count(*) FROM post where postPublished = 0 and postRejected = 0');
                                            ...
                                            <div class="table-responsive table-hover">
                                                <table class="table m-0" id="tableView">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $stmt = $db->query('SELECT * FROM post where postPublished = 0 and postRejected = 0 ORDER BY postId DESC ' . $pages->get_limit());
