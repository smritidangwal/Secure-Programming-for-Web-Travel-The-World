		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"> Rejected Posts </h1>
						</div><!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="./">Home</a></li>
								<li class="breadcrumb-item active"> Rejected Posts </li>
							</ol>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							try {
								...
								$stmt = $db->query('SELECT count(*) FROM post where postRejected = 1');
											...
											<div class="table-responsive">
												<table class="table m-0" id="tableView">
													...
													<tbody>
														...
														$stmt = $db->query('SELECT * FROM post  where postRejected = 1 ORDER BY postId DESC ' . $pages->get_limit());
															...
															<tr>
																<td>
																	<a href="viewPost.php?id=<?php echo $row['postId']; ?>">
																		<button class="badge badge-danger">View</button>
																	</a>
																</td>
