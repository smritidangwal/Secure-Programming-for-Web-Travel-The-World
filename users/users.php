...
checkIfRoleAuthorized('User', $handler = false);
?>
<!DOCTYPE html>
<html>

<head>
    <title> Travel The World | Users</title>
    <?php head(); ?>
</head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            try {
                                ...
                                $stmt = $db->query('SELECT count(*) FROM admin WHERE ROLE = "AUTHOR"');
                                            ...
                                            <div class="table-responsive">
                                                <table class="table m-0" id="tableView">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $stmt = $db->query('SELECT * FROM admin WHERE ROLE = "AUTHOR" ORDER BY memberId DESC ' . $pages->get_limit());
