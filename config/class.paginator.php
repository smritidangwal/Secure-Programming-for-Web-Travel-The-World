	...
	public function page_links($path = '?', $ext = null)
	{
		...
		if ($lastpage > 1) {
			...
			if ($this->_page > 1)
				...
				$pagination .= "<li class='page-item disabled'><a class='page-link' href='#'><span class='disabled'>&laquo; </span></a></li>";

			if ($lastpage < 7 + ($adjacents * 2)) {
				for ($counter = 1; $counter <= $lastpage; $counter++) {
					if ($counter == $this->_page)
						$pagination .= "<li class='page-item active'><a class='page-link' href='#'><span class='current'>$counter</span></a></li>";
					else
				...
				if ($this->_page < 1 + ($adjacents * 2)) {
					for ($counter = 1; $counter < 4 + ($adjacents * 2); $counter++) {
						if ($counter == $this->_page)
							$pagination .= "<li class='page-item'><a class='page-link' href='#'><span class='current'>$counter</span></a></li>";
						else
							$pagination .= "<li class='page-item'><a class='page-link' href='" . $path . "$this->_instance=$counter" . "$ext'>$counter</a></li>";
					}
					$pagination .= "...";
			...
			if ($this->_page < $counter - 1)
				...
				$pagination .= "<li class='page-item disabled'><a class='page-link' href='#'><span class='disabled'> &raquo;</span></a></li>";
			$pagination .= "</div>\n";
		}
