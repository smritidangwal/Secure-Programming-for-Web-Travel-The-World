...
<body>
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            ...
                            <p>Dublin 1, Ireland</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
                            <h3>+353 899 643526</h3>
    ...
    <!-- ================ contact section end ================= -->
    <div class="modal fade custom_search_pop" id="success" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="serch_form">
                    <h3 class="p-3 text-success">Success. We have received your response.</h3>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade custom_search_pop" id="error" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="serch_form">
                    <h3 class="p-3 text-warning">Error. Please try again.</h3>
                </div>
            </div>
        </div>
    </div>
